    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // If PictureUrl is not null, process the image upload
                if (Input.PictureURL != null)
                {
                    ImageOperations imageOperations = new ImageOperations(_webHostEnvironment);
                    string fileName = imageOperations.ImageUpload(Input.PictureURL);
